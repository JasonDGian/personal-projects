...
- I modeled the motherboard holder with a lot of freedmo because i did not keep in mind that IT might be a little to high or too wide with all the componentes assembled. Some pieces became larger for better usage compared to what i initially thought and the motherboard holder was certainly much bigger than what i could've reduced it to. So basically, i should've let this piece be the last one and only design it once the main componentes that actually matter in position were already made.
